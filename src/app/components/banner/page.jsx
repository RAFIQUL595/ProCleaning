            ...
            <div>
                <div className='ml-5 md:ml-10 absolute top-4 md:top-20 lg:top-25 md:space-y-1'>
                    ...
                    <div className='flex gap-2 md:gap-3 mt-2 md:mt-5'>
                        <Link href="/book-service"><button className='bg-[#04BE64] text-xs md:text-sm text-white btn'>Get  Start Now</button></Link>
                        <Link href="/service"><button className='btn text-xs md:text-sm'>View all Services</button></Link>
                    </div>
                </div>
